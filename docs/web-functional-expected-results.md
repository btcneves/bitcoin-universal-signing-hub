...
- Esta matriz já incorpora evidência real da rodada manual parcial.
- Bugs reais que foram observados e corrigidos durante a execução: falso positivo para PSBT truncada e falso positivo para endereço Bech32 inválido.
...
| **WF-B10** | Estável      | Endereço inválido detectado como `unknown` (inclui vetores anteriormente reportados como falso positivo).                                                                      | Falso positivo para checksum/prefixo inválido.         |
